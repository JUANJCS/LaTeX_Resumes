...
% Sprache: Deutsch (Business Fluent) | Final Version | 0 Errors
...
% Layout Spacing
\setlist[itemize]{leftmargin=0.15in, itemsep=0pt, topsep=2pt, parsep=0pt, partopsep=0pt} 
\linespread{1.0} 
...
% ============================================================ 
\begin{center} 
    {\Huge\bfseries JUAN CANO-SELLES} \\ \vspace{4pt}
    
    \textbf{Spanischer Staatsbürger (EU) | Arbeitsbewilligung bei Vertragsabschluss | Umzugsbereit} \\ \vspace{2pt}
    +49 163 150 9581 | \href{mailto:juan.cano.selles@gmail.com}{juan.cano.selles@gmail.com} | \href{https://www.linkedin.com/in/jcanoselles}{linkedin.com/in/jcanoselles} \\ \vspace{2pt}
    \textbf{Englisch: C2 | Deutsch: C1 (Verhandlungssicher) | Sofort verfügbar}
\end{center}
