...
\newlength{\TitleBulletGap}     % small gap between job title line and bullets
\setlength{\TitleBulletGap}{0.25ex}
\newlength{\BetweenJobsGap}     % bigger gap between jobs
\setlength{\BetweenJobsGap}{1.5ex}

% Corrected job block environment
\newenvironment{job}[3]{%
  \vspace{\BetweenJobsGap}% ensure gap belongs to the end of previous job
...
\setlength{\topskip}{0pt} % kill automatic top gap
\raggedbottom

% ==== WRAP IN MINIPAGE TO AVOID BLANK PAGE ====
\noindent\begin{minipage}{\textwidth}
% --- LEFT COLUMN full-height background ---
\colorbox{cvblue!90}{%
  \parbox[t][\paperheight][t]{\SideBarW}{%
    \hspace*{4mm}%
    \begin{minipage}[t]{\dimexpr\linewidth-8mm\relax}
      \color{softwhite}
      \vspace*{6mm} % top padding for photo
      \begin{center}
